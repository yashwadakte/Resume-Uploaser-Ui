          ...
          <Box component="form" sx={{ p: 3 }} noValidate id="resume-form" onSubmit={handleSubmit}>
            ...
            <FormControl component='fieldset' fullWidth margin='normal'>
              ...
              <FormGroup row>
                ...
                <FormControlLabel control={<Checkbox />} label="Pune" value="Ranchi" onChange={(e) => getPjl(e)} />
                <FormControlLabel control={<Checkbox />} label="Nashik" value="Kolkata" onChange={(e) => getPjl(e)} />
              </FormGroup>
            </FormControl>
            ...
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              ...
              <TableBody>
                <TableRow sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                  <TableCell align="center">yash</TableCell>
                  <TableCell align="center">yashwadakte@gmail.com</TableCell>
                  <TableCell align="center">08/10/2000</TableCell>
                  <TableCell align="center">Maharashtra</TableCell>
                  <TableCell align="center">male</TableCell>
                  <TableCell align="center">Nashik Maharashtra </TableCell>
